...
export default function NotFound() {
  ...
  return (
    <div className="dark:bg-dark min-h-screen flex flex-col items-center justify-center bg-gray-50 text-gray-800 px-6">
      ...
      <p className="mt-2 text-gray-500 dark:text-gray-300 text-center max-w-md">
