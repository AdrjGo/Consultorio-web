...
import { TreatmentSummaryPDF } from "./TreatmentSummaryPDF";
import type { ClinicalReportData, ClinicInfo } from "@types";

export async function exportTreatmentSummaryPDF(
  patientId: string,
  patientName: string,
  patientCi: string,
): Promise<void> {
  try {
    ...
    a.href = url;
    a.download = `${patientName}-${patientCi}-resumen-tratamiento.pdf`;
